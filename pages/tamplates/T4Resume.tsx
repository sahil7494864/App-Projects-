...
export default function T4Resume() {
        ...
        <View style={styles.container}>
          ...
          <View style={styles.resume}>
            ...
            <View style={styles.firstcontent}>
                <Text style={{ textAlign: 'center', fontSize: 30, fontWeight: 400,  }}>{personalData.name} {personalData.lastName}</Text>
              <Text style={{ textAlign: 'center', fontSize: 15, color: '#898f96', fontWeight: 300 }}>{personalData.profession}</Text>
            ...
            <Text style={styles.heading}>CONTACT</Text>
              ...
              <View style={styles.item}>
                ...
                <Text style={{  borderBottomWidth:1,borderBottomColor:'lightgrey',borderStyle:'dotted', height: 1, width: '80%',marginTop:3 }}></Text>  
            ...
            <View style={styles.border}> 
            <Text style={styles.heading}>PROFILE</Text>{about.length===0?(
